...
public class StandardBeanExpressionResolver implements BeanExpressionResolver {
	...
	public Object evaluate(String value, BeanExpressionContext evalContext) throws BeansException {
		...
		if ("#{myBeanDefinitionRegistryConfig.className}".equals(value)) {
			System.out.println();
		}
		if ("#{myBeanDefinitionRegistryConfig.name}".equals(value)) {
			System.out.println();
		}
		if ("#{MyBeanDefinitionRegistry_class222}".equals(value)) {
			System.out.println();
		}
		try {
